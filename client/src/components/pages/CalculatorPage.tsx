...
export default function CalculatorPage(): JSX.Element {
  return (
    <Box>
      <Typography variant="h4" className="text-3xl font-bold mb-6" sx={{color: '#1976D2'}}>Расчет стоимости переезда</Typography>
      ...
      <Box>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
          <Typography variant="h4" sx={{ fontSize: 'xl', fontWeight: 'semibold', color: '#1976D2' }}>Общая стоимость:</Typography>
          <Typography variant="h5" sx={{ fontSize: '3xl', fontWeight: 'bold', color: '#1976D2' }}>0 руб.</Typography>
        </Box>
        <Box sx={{ mb: 4 }}>
